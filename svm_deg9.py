...
if __name__ == '__main__':
    ...
    pipe = make_pipeline(preprocess('sift', flatten=True), PCA(n_components=5000),
                         SVC(kernel='poly', degree=9, cache_size=20000, verbose=True, decision_function_shape='ovr'))
